...
describe("API ENDPOINT TESTING", () => {
  ...
  it("POST Booking Page", (done) => {
    ...
    const dataSample = {
      ...
      duration: 4,
      bookingStartDate: "20-5-2022",
      bookingEndDate: "24-5-2022",
      firstName: "duljabut",
      lastName: "dulkolak",
      email: "duljabut@gmail.com",
      phoneNumber: "081212348765",
      accountHolder: "duljabut",
      bankFrom: "BNI",
    };
    chai
      .request(app)
      ...
      .end((err, res) => {
        ...
        console.log(res.body.booking.payments);
        done();
      });
  });
});
